...
auto build_network(std::shared_ptr<neuralfield::Network> net,
    ...
    double sp     = get_param(lbounds, ubounds, params, 3);
...
int main(int argc, char * argv[]) {
    ...
    //                                  dttau     h,  Ap,   sp, ka 
    std::array<double, Nparams> tlbounds({0.01, -5.0, 0.01,  0.0001, -1.0});
    std::array<double, Nparams> tubounds({0.20,  5.0, 100000.0,  .5,    0.0});
    ...
    sp       = get_param(tlbounds, tubounds, best_params, 3);
